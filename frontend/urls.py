...
urlpatterns = [
   ...
   # path('profile/', views.profile, name='profile'),
    ...
    # API routes
    path('api/mpesa-payment/<int:signal_id>/', views.process_mpesa_payment, name='mpesa_payment'),
    path('api/paypal-payment/<int:signal_id>/', views.process_paypal_payment, name='paypal_payment'),
